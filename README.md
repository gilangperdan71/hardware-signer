...
<p align="center">
  <sub>ledger · trezor · psbt</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>HwSigner</code> &nbsp;·&nbsp; <code>hwsigner</code>
</p>
...
Hardware wallet companion — PSBT compose, device connect stubs, broadcast queue.
...
```bash
dotnet restore hardware-signer.slnx
dotnet build hardware-signer.slnx -c Release
dotnet test hardware-signer.slnx -c Release
```
